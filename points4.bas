      ...
      G=25: REM strength of attractors, points are pulled towards attractors
      RP=16: REM strength of repulsors, points are pushed away from repulsors
      DRAG=1E-3: REM drag proportional to velocity
      ATTRACTRAD=12: ATTRACTRADSQ=ATTRACTRAD^2
      Npoints%=375: REM total number of points in system
      Nattract=4: REM total number of attractors in system
      ...
      xattract()=-R/2, R/2, -R/2, R/2: REM define position of attractors
      yattract()=R/2, R/2, -R/2, -R/2
